...
export const addLiquidityAccounts = async ({ marinadeState, ownerAddress, associatedLPTokenAccountAddress }: {
...
export const removeLiquidityAccounts = async ({ marinadeState, ownerAddress, associatedLPTokenAccountAddress, associatedMSolTokenAccountAddress }: {
  marinadeState: MarinadeState,
  ownerAddress: web3.PublicKey,
  associatedLPTokenAccountAddress: web3.PublicKey,
...
export const depositAccounts = async ({ marinadeState, ownerAddress, associatedMSolTokenAccountAddress }: {
  marinadeState: MarinadeState,
  ownerAddress: web3.PublicKey,
  associatedMSolTokenAccountAddress: web3.PublicKey,
...
export const liquidUnstakeAccounts = async ({ marinadeState, ownerAddress, associatedMSolTokenAccountAddress }: {
  marinadeState: MarinadeState,
  ownerAddress: web3.PublicKey,
  associatedMSolTokenAccountAddress: web3.PublicKey,
...
export const depositStakeAccountAccounts = async ({
  marinadeState,
  duplicationFlag,
  ownerAddress,
  stakeAccountAddress,
